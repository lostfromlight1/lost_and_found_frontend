      ...
      >
        <div className="flex flex-col min-h-full bg-slate-100">
          <div className="sticky top-0 bg-white/90 backdrop-blur-md z-30 border-b border-slate-100 flex items-center cursor-pointer shrink-0">
            ...
            >
              <span className={feedTab === "LATEST" ? "text-slate-900" : "text-slate-500 font-medium"}>
                Latest
              </span>
              {feedTab === "LATEST" && (
            ...
            <div
              ...
              className="flex-1 hover:bg-slate-50 transition-colors text-center font-bold text-[15px] pt-4 pb-3 relative"
            >
              <span className={feedTab === "TOP" ? "text-slate-900" : "text-slate-500 font-medium"}>
                Top Posts
              </span>
              {feedTab === "TOP" && (
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-20 h-1 bg-[#1d9bf0] rounded-t-sm" />
              )}
            </div>
          </div>
