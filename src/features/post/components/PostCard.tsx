...
import { useDeletePost, useToggleLikePost } from "@/features/post/hooks/usePosts";
...
import CommentCard, { CurrentUser } from "@/features/comments/components/CommentCard"; // <-- Imported new CommentCard
