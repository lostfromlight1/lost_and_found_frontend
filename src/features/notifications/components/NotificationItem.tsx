...
export function NotificationItem({ notification }: NotificationItemProps) {
  ...
  return (
    <div
      ...
      className={`group flex items-start gap-4 p-4 md:p-6 border-b border-slate-100 transition-colors cursor-pointer ${isUnread ? "bg-slate-50/50" : "bg-white hover:bg-slate-50/30"
        }`}
    >
