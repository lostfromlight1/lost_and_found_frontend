        ...
        <div className="flex flex-col gap-6">
          ...
          <label className="flex items-center justify-between cursor-pointer group">
            ...
            <input
              ...
              // FIX: Added text color here as well for consistency if using Tailwind forms
              className="w-4 h-4 accent-[#1d9bf0] text-[#1d9bf0] focus:ring-[#1d9bf0] cursor-pointer rounded-sm border-slate-300"
            />
          </label>
              ...
              {[
                ...
                <label key={type.id} className="flex items-center justify-between cursor-pointer group">
                  ...
                  <input
                    ...
                    // FIX: Added text-[#1d9bf0] to color the radio dot, and focus:ring for accessibility
                    className="w-4 h-4 accent-[#1d9bf0] text-[#1d9bf0] focus:ring-[#1d9bf0] border-slate-300 cursor-pointer"
                  />
                </label>
              ))}
            </div>
